use super::{ItemTarget, SecretStore, StoreError, StoreOutcome, StoreTarget, StoreWarning};
use crate::domain::{Attributes, CollectionInfo, ItemInfo, NewCollection, NewItem, SecretValue};
