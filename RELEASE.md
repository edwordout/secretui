...
- No compatibility claim is added until the isolated live test passes against
  that exact source. The v0.1.4 gate is Ubuntu 26.04/KDE with KWallet 6.24.0;
...
No signing key is configured for v0.1.4, so use an annotated **unsigned** tag.
...
For v0.1.4, confirm version consistency:
...
test "$($BIN --version)" = "secretui 0.1.4"
$BIN --help >/dev/null
...
test "$("$install_root/root/bin/secretui" --version)" = "secretui 0.1.4"
rm -rf "$install_root"
```
...
```text
secretui-v0.1.4-x86_64-unknown-linux-gnu/
secretui-v0.1.4-x86_64-unknown-linux-gnu/secretui
secretui-v0.1.4-x86_64-unknown-linux-gnu/secretui.1
secretui-v0.1.4-x86_64-unknown-linux-gnu/secretui.bash
secretui-v0.1.4-x86_64-unknown-linux-gnu/ss.png
secretui-v0.1.4-x86_64-unknown-linux-gnu/README.md
secretui-v0.1.4-x86_64-unknown-linux-gnu/SECURITY.md
secretui-v0.1.4-x86_64-unknown-linux-gnu/CHANGELOG.md
secretui-v0.1.4-x86_64-unknown-linux-gnu/METADATA.md
secretui-v0.1.4-x86_64-unknown-linux-gnu/RELEASE.md
secretui-v0.1.4-x86_64-unknown-linux-gnu/LICENSE-APACHE
secretui-v0.1.4-x86_64-unknown-linux-gnu/LICENSE-MIT
```
...
`/tmp/release-secretui-v0.1.4.sh` automates the maintainer-controlled portion.
...
`main`, and creates and pushes annotated tag `v0.1.4`. When the GitHub CLI (`gh`)
...
The workflow creates a draft release using the exact v0.1.4 changelog section,
